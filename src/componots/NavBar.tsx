      ...
      <>
        <div className="  border-b border-white md:flex hidden  items-center py-8 justify-around">
          ...
          <ul className=" flex items-center gap-8">
            ...
            <li>
              <NavLink className=" hover:text-omar transition-all text-white" to="Movies">
                Movies
              </NavLink>
            </li>
            <li>
              <NavLink className=" hover:text-omar transition-all text-white" to="series">
                Series
              </NavLink>
            </li>
            <li>
              <NavLink className=" hover:text-omar transition-all text-white" to="list">
                My List
              </NavLink>
            </li>
          </ul>
